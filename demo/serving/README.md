...
### PaddleHub Serving的组成
PaddleHub Serving主要包括利用Bert Service实现embedding服务化，以及利用预测模型实现预训练模型预测服务化两大功能，未来还将支持开发者利用PaddleHub自己finetune后的模型服务化。
...
关于Paddle-Serving一键模型部署功能的具体信息请参与[serving](module_serving)
