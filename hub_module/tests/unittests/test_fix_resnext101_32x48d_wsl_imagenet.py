...
class TestFixResnext10132x48dwslImagenet(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        """Prepare the environment once before execution of all tests.\n"""
        # self.classifier = hub.Module(name="resnet50_vd_animals")
        self.classifier = hub.Module(
            directory='fix_resnext101_32x48d_wsl_imagenet')
...
if __name__ == "__main__":
    ...
    suite.addTest(TestFixResnext10132x48dwslImagenet('test_single_pic'))
    suite.addTest(TestFixResnext10132x48dwslImagenet('test_batch'))
    suite.addTest(TestFixResnext10132x48dwslImagenet('test_ndarray'))
    suite.addTest(
        TestFixResnext10132x48dwslImagenet('test_save_inference_model'))
