...
from efficientnetb5_imagenet.processor import postprocess, base64_to_cv2
from efficientnetb5_imagenet.data_feed import reader
from efficientnetb5_imagenet.efficientnet import EfficientNetB5
...
class EfficientNetB5ImageNet(hub.Module):
    def _initialize(self):
        self.default_pretrained_model_path = os.path.join(
            self.directory, "efficientnetb5_imagenet_infer_model")
    ...
    def context(self,
        ...
        with fluid.program_guard(context_prog, startup_prog):
            with fluid.unique_name.guard():
                ...
                output, feature_map = efficientnet_b5.net(
                    input=image,
