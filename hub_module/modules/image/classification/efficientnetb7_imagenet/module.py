...
from efficientnetb7_imagenet.data_feed import reader
...
@moduleinfo(
    ...
    version="1.1.0")
class EfficientNetB7ImageNet(hub.Module):
    def _initialize(self):
        self.default_pretrained_model_path = os.path.join(
            self.directory, "efficientnetb7_imagenet_infer_model")
    ...
    def context(self,
        ...
        with fluid.program_guard(context_prog, startup_prog):
            with fluid.unique_name.guard():
                ...
                output, feature_map = efficientnet_b7.net(
                    input=image,
