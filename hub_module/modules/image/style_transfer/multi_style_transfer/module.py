...
class Vgg16(nn.Layer):
    ...
    def __init__(self):
        ...
        checkpoint = os.path.join(abs_path, 'vgg16.pdparams')
...
@moduleinfo(name="msgnet",
            type="CV/image_editing",
            author="paddlepaddle",
            author_email="",
            summary="Msgnet is a image style transfer model, this module is trained with COCO2014 dataset.",
            version="1.0.0",
...
class MSGNet(nn.Layer):
    ...
    def __init__(self,
        ...
        if load_checkpoint is not None:
            ...
            abs_path = os.path.abspath(".")
            checkpoint = os.path.join(abs_path, 'style_paddle.pdparams')
            if not os.path.exists(checkpoint):
