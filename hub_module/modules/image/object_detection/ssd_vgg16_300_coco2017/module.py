    ...
    def context(self,
        ...
        with fluid.program_guard(context_prog, startup_program):
            with fluid.unique_name.guard():
                ...
                # var_prefix
                var_prefix = var_prefix if var_prefix else '@HUB_{}@'.format(self.name)
                # names of inputs 
                inputs = {'image': var_prefix + image.name,
                ...
                outputs = {out_key: [context_prog.global_block().vars[varname] for varname in out_value] for out_key, out_value in outputs.items()}
                # trainable
