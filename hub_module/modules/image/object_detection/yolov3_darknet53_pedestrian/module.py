    ...
    def context(self,
        ...
        with fluid.program_guard(context_prog, startup_program):
            with fluid.unique_name.guard():
                ...
                # head_features
                head_features = yolo_head._get_outputs(body_feats, is_train=trainable)
                ...
                if get_prediction:
                    ...
                    outputs = {'head_features': [var_prefix + var.name for var in head_features]}
                # add_vars_prefix
                ...
                # outputs
                outputs = {key: [context_prog.global_block().vars[varname] for varname in value] for key, value in outputs.items()}
                # trainable
