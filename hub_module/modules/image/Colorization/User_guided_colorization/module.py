...
from paddlehub.process.transforms import *
...
class Userguidedcolorization(nn.Layer):
    ...
    def __init__(self, use_tanh: bool = True, classification: bool = True, load_checkpoint: str = None):
        ...
        # Conv1
        model1 = (Conv2d(self.input_nc, 64, 3, 1, 1),
                  nn.ReLU(),
                  Conv2d(64, 64, 3, 1, 1),
                  nn.ReLU(),
                  nn.BatchNorm(64),)
        # Conv2
        model2 = (Conv2d(64, 128, 3, 1, 1),
                  nn.ReLU(),
                  Conv2d(128, 128, 3, 1, 1),
                  nn.ReLU(),
                  nn.BatchNorm(128),)
        # Conv3
        model3 = (Conv2d(128, 256, 3, 1, 1),
                  nn.ReLU(),
    ...
    def forward(self, input_A: paddle.Variable, input_B: paddle.Variable, mask_B: paddle.Variable, real_b: paddle.Variable = None, real_B_enc: paddle.Variable = None) -> paddle.Variable:
