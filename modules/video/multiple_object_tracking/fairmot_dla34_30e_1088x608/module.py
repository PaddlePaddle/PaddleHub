...
@moduleinfo(
    name="fairmot_dla34_30e_1088x608",
...
class FairmotTracker_1088x608(hub.Module):
    ...
    def mot_predict(self, video_stream, output_dir='', visualization=True, draw_threshold=0.5, use_gpu=False, from_device=False):
    ...
    @serving
    def serving_method(self, video_stream: str, **kwargs):
        """
        Run as a service.
        """
        pass
    ...
    def run_cmd(self, argvs: list):
        ...
        self.mot_predict(
            ...
            from_device = self.args.from_device
        )
    
    def signalhandler(self, signum, frame):
        seq = os.path.splitext(os.path.basename(self.args.video_stream))[0]
        save_dir = os.path.join(self.args.output_dir, 'mot_outputs',
                                seq) if self.args.visualization else None
    ...
    def add_module_config_arg(self):
        ...
        self.arg_config_group.add_argument(
            '--use_gpu', action='store_true', help="use GPU or not")
        
        self.arg_config_group.add_argument(
            '--from_device', action='store_true', help="=read from camera device")
    ...
    def add_module_input_arg(self):
        ...
        """
        self.arg_input_group.add_argument('--video_stream', type=str, help="path to video stream, can be a video file or stream device number.")
