...
- ### 应用效果展示
  - 样例结果示例：
    ...
    <p align="center">
    <img src="https://ai-studio-static-online.cdn.bcebos.com/495436a627ef423ab572536c5f2ba6d0eb99b1ce098947a5ac02af36e7eb85f7"  width = "450" height = "300" hspace='10'/> <br />
    </p> 
...
- ### 1、命令行预测
  ...
  - ```shell
    $ hub run animegan_v2_paprika_98 --input_path "/PATH/TO/IMAGE"
    ```
