...
- ### 应用效果展示
  - 样例结果示例：
    ...
    <p align="center">
    <img src="https://ai-studio-static-online.cdn.bcebos.com/6574669d87b24bab9627c6e33896528b4a0bf5af1cd84ca29655d68719f2d551"  width = "450" height = "300" hspace='10'/> <br />
    </p> 
...
- ### 1、命令行预测
  ...
  - ```shell
    $ hub run animegan_v2_paprika_74 --input_path "/PATH/TO/IMAGE"
    ```
