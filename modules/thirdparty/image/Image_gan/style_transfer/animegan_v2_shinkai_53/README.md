...
- ### 应用效果展示
  - 样例结果示例：
    ...
    <p align="center">
    <img src="https://ai-studio-static-online.cdn.bcebos.com/fa4ba157e73c48658c4c9c6b8b92f5c99231d1d19556472788b1e5dd58d5d6cc"  width = "450" height = "300" hspace='10'/> <br />
    </p> 
...
- ### 1、命令行预测
  ...
  - ```shell
    $ hub run animegan_v2_shinkai_53 --input_path "/PATH/TO/IMAGE"
    ```
