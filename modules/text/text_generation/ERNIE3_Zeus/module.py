...
class ERNIE3Zeus:
    @staticmethod
    def custom_generation(api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = '', topk: int = 10,
                          temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                          is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
    ...
    def article_creation(self, api_key: str, secret_key: str, text: List[str], seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = 'zuowen', topk: int = 10,
                         temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                         is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 作文创作
        ...
        return self.custom_generation(
            api_key, secret_key, text, seq_len, task_prompt, dataset_prompt, topk,
            temperature, penalty_score, penalty_text,  choice_text, stop_token,
            is_unidirectional, min_dec_len, min_dec_penalty_text
        )

    def copywriting_creation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = '', topk: int = 10,
                             temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                             is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 文案创作
    ...
    def text_summarization(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'Summarization', dataset_prompt: str = '', topk: int = 10,
                           temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                           is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 摘要生成
    ...
    def question_generation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'QuestionGeneration', dataset_prompt: str = '', topk: int = 10,
                            temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                            is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 问题生成
    ...
    def poetry_creation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = 'poetry', topk: int = 10,
                        temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                        is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 古诗创作
    ...
    def couplet_continuation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = 'couplet', topk: int = 10,
                             temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                             is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 对联续写
    ...
    def answer_generation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = '', topk: int = 10,
                          temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                          is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 自由问答
    ...
    def article_continuation(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = '', topk: int = 10,
                             temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                             is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 小说续写
    ...
    def sentiment_classification(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'SentimentClassification', dataset_prompt: str = '', topk: int = 10,
                                 temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                                 is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 情感分析
    ...
    def information_extraction(self, api_key: str, secret_key: str, text: List[str], seq_len: int = 256, task_prompt: str = 'QA_MRC', dataset_prompt: str = '', topk: int = 10,
                               temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                               is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 信息抽取
    ...
    def synonymous_rewriting(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'Paraphrasing', dataset_prompt: str = '', topk: int = 10,
                             temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                             is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 同义改写
    ...
    def semantic_matching(self, api_key: str, secret_key: str, text: List[str], seq_len: int = 256, task_prompt: str = 'SemanticMatching', dataset_prompt: str = '', topk: int = 10,
                          temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                          is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 文本匹配
    ...
    def text_correction(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'Correction', dataset_prompt: str = '', topk: int = 10,
                        temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                        is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 文本纠错
    ...
    def text_cloze(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = '', dataset_prompt: str = '', topk: int = 10,
                   temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                   is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
        ERNIE 3.0 Zeus 完形填空
    ...
    def text2SQL(self, api_key: str, secret_key: str, text: str, seq_len: int = 256, task_prompt: str = 'Text2SQL', dataset_prompt: str = '', topk: int = 10,
                 temperature: float = 1.0, penalty_score: float = 1.0, penalty_text: str = '',  choice_text: str = '', stop_token: str = '',
                 is_unidirectional: bool = False, min_dec_len: int = 1, min_dec_penalty_text: str = '') -> str:
        '''
