...
@moduleinfo(
    name='ernie_zeus_copywriting_generation',
    type='nlp/text_generation',
    author='paddlepaddle',
    author_email='',
    summary='ernie_zeus_copywriting_generation',
    version='1.0.0'
)
class ERNIEZeus:
    ...
    def copywriting_generation(self,
        ...
        文案生成
        '''
        return self.ernie_zeus.copywriting_generation(
            text,
            min_dec_len,
            seq_len,
            topp,
    ...
    def cmd(self, argvs):
        ...
        return self.copywriting_generation(**kwargs)
