```shell
$ hub install bert_chinese_L-12_H-768_A-12==2.0.0
```
<p align="center">
...
```shell
$ hub serving start -m bert_chinese_L-12_H-768_A-12
```
...
url = "http://10.12.121.132:8866/predict/bert_chinese_L-12_H-768_A-12"
