```shell
$ hub install bert_cased_L-24_H-1024_A-16==2.0.0
```
<p align="center">
...
```shell
$ hub serving start -m bert_cased_L-24_H-1024_A-16
```
...
url = "http://10.12.121.132:8866/predict/bert_cased_L-24_H-1024_A-16"
