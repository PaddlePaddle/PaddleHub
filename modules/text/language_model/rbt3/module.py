...
class Roberta(nn.Layer):
    ...
    def get_vocab_path(self):
        ...
        """
        save_path = os.path.join(DATA_HOME, 'rbt3', 'vocab.txt')
        if not os.path.exists(save_path) or not os.path.isfile(save_path):
            url = "https://paddlenlp.bj.bcebos.com/models/transformers/rbt3/vocab.txt"
            download(url, os.path.join(DATA_HOME, 'rbt3'))
        return save_path
