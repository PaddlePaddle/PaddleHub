...
if __name__ == "__main__":
    ...
    roberta = hub.Module(
        directory='/mnt/zhangxuefei/program-paddle/PaddleHub/modules/text/language_model/chinese_roberta_wwm_ext_large',
        version='2.0.0')
    sequence_output, pooled_output = roberta(src_ids, sent_ids)  #, pos_ids, input_mask)
    print(sequence_output.shape)
    print(pooled_output.shape)
    vocab_path = roberta.get_vocab_path()
