```shell
$ hub install chinese-roberta-wwm-ext-large==2.0.0
```
<p align="center">
...
```shell
$ hub serving start -m chinese-roberta-wwm-ext-large
```
...
url = "http://10.12.121.132:8866/predict/chinese-roberta-wwm-ext-large"
