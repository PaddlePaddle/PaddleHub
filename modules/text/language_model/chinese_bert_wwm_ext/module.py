...
class BertWwm(nn.Layer):
    ...
    def get_vocab_path(self):
        ...
        """
        save_path = os.path.join(DATA_HOME, 'chinese-bert-wwm-ext', 'bert-wwm-ext-chinese-vocab.txt')
        if not os.path.exists(save_path) or not os.path.isfile(save_path):
            url = "http://paddlenlp.bj.bcebos.com/models/transformers/bert/bert-wwm-ext-chinese-vocab.txt"
            download(url, os.path.join(DATA_HOME, 'chinese-bert-wwm-ext'))
        return save_path
