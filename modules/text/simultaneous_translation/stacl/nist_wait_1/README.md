...
- ### 模型介绍
    ...
    STACL 主要具有以下优势：
        ...
        ![image](https://user-images.githubusercontent.com/40840292/133761990-13e55d0f-5c3a-476c-8865-5808d13cba97.png)

        - Wait-k策略可以不需要全句的源句，直接预测目标句，可以实现任意的字级延迟，同时保持较高的翻译质量。

        ![image](https://user-images.githubusercontent.com/40840292/133762098-6ea6f3ca-0d70-4a0a-981d-0fcc6f3cd96b.png)
    
    该PaddleHub Module基于transformer网络结构，支持预测。
...
- ### 1、预测代码示例
  ...
  - ```python
    ...
    nist_wait_1 = hub.Module(name="nist_wait_1")
...
- ### 第一步：启动PaddleHub Serving
  ...
  - ```shell
    $ hub serving start -m nist_wait_1
    ```

  - 启动时会显示加载模型过程，启动成功后显示

  - ```shell
    Loading nist_wait_1 successful.
    ```
...
- ### 第二步：发送预测请求
  ...
  - ```python
    ...
    # HOST_IP为服务器IP
    url = "http://HOST_IP:8866/predict/nist_wait_1"
