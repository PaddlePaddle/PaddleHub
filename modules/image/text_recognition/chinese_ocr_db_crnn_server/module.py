...
class ChineseOCRDBCRNNServer(hub.Module):
    def _initialize(self, text_detector_module=None):
        ...
        char_ops_params = {'character_type': 'ch', 'character_dict_path': self.character_dict_path, 'loss_type': 'ctc'}
        ...
        self.pretrained_model_path = os.path.join(self.directory, 'assets', 'ch_rec_r34_vd_crnn')
        self._set_config()
    ...
    def save_result_image(self, original_image, detection_boxes, rec_results, output_dir='ocr_result', text_thresh=0.5):
