...
@moduleinfo(
    ...
    summary="Baidu's YOLOv3 model for object detection with backbone ResNet34, trained with dataset coco2017.",
    author="paddlepaddle",
    author_email="paddle-dev@baidu.com")
class YOLOv3ResNet34Coco2017(hub.Module):
    def _initialize(self):
        self.default_pretrained_model_path = os.path.join(self.directory, "yolov3_resnet34_model")
    ...
    def context(self, trainable=True, pretrained=True, get_prediction=False):
        ...
        with fluid.program_guard(context_prog, startup_program):
            with fluid.unique_name.guard():
                ...
                # backbone
                backbone = ResNet(
                    norm_type='bn', freeze_at=0, freeze_norm=False, norm_decay=0., depth=34, feature_maps=[3, 4, 5])
                # body_feats
