...
_DATA_URL = "https://bj.bcebos.com/paddlehub-dataset/poetry.tar.gz"


class Poetry(GenerationDataset):
    """
    An open source poetry dataset, see https://github.com/chinese-poetry/chinese-poetry for details.
    """

    def __init__(self, tokenizer=None, max_seq_len=None):
        dataset_dir = os.path.join(DATA_HOME, "poetry")
...
if __name__ == "__main__":
    ...
    ds = Poetry(tokenizer=tokenizer, max_seq_len=30)
