...
class SQUAD(object):
    ...
    def _load_train_examples(self,
        ...
        if not version_2_with_negative:
            train_file = os.path.join(self.dataset_dir, "train-v1.1.json")
        else:
            train_file = os.path.join(self.dataset_dir, "train-v2.0.json")

        self.train_examples = self._read_json(train_file, is_training,
    ...
    def _load_dev_examples(self,
                           ...
                           is_training=False):
        if not version_2_with_negative:
            dev_file = os.path.join(self.dataset_dir, "dev-v1.1.json")
        else:
            dev_file = os.path.join(self.dataset_dir, "dev-v2.0.json")
